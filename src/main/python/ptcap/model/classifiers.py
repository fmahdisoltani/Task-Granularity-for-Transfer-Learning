...
from ptcap.model.decoders import DecoderBase
...
class RtorchnCaptioner(Classifier):
    """
...
class CNN3dLSTM(EncoderDecoder):
    def __init__(self, encoder_output_size=128, embedding_size=31,
        ...
        super(CNN3dLSTM, self).__init__(CNN3dLSTMEncoder, DecoderBase,
