...
if __name__ == "__main__":
    ...
    output_jsons = [
        "/home/farzaneh/PycharmProjects/pytorch-captioning/src/main/python/scripts/v2-train-simple.json",
        "/home/farzaneh/PycharmProjects/pytorch-captioning/src/main/python/scripts/v2-validation-simple.json"]


    for in_json, out_json in zip(input_jsons, output_jsons):
        print("Creating subset from {} to {}".format(in_json, out_json))
        new_json = json_process(in_json, True)
